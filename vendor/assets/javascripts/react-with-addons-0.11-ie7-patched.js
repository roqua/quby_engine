// provide dummy console function
  ...
  dangerouslyRenderMarkup: function(markupList) {
    ...
    for (nodeName in markupByNodeName) {
      ...
      for (i = 0; i < renderNodes.length; ++i) {
        ...
        // ROQUA EDIT: getAttribute in the or-clause added for IE7 compatibility
        if ((renderNode.hasAttribute && renderNode.hasAttribute(RESULT_INDEX_ATTR)) || (renderNode.getAttribute && renderNode.getAttribute(RESULT_INDEX_ATTR) !== null)) {
        // END ROQUA EDIT
