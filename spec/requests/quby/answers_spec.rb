  ...
  describe AnswersController, type: :controller do
    ...
    describe '#update' do
      ...
      it 'saves the answer' do
        ...
        # put "/questionnaires/honos/answers/#{answer.id}", answer: {v_1: nil}
        put :update, { questionnaire_id: 'honos', id: answer.id, answer: { v_1: nil} }
      ...
      context 'upon successful save' do
        ...
        it 'renders print view if printing' do
          ...
          put :print, questionnaire_id: 'honos', id: answer.id, answer: {v_1: nil}
        ...
        it 'redirects to roqua if return url is set' do
          ...
          put :update, questionnaire_id: 'honos', id: answer.id,
              answer: {v_1: nil},
              return_url: return_url,
              return_token: return_token
