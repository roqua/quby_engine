  ...
  describe Questionnaire do
    ...
    describe '#add_score_calculation' do
      ...
      it 'throws exception if there already is a score builder known for this key' do
        ...
        expect do
          questionnaire.add_score_calculation double(key: "c")
        end.to raise_error(Quby::Compiler::Entities::Questionnaire::InputKeyAlreadyDefined,
    ...
    describe '#to_codebook' do
      it "should be able to generate a codebook" do
        questionnaire = Quby::Compiler::DSL.build("test") do
          title 'My Test'
    ...
    describe '#questions_of_type' do
      ...
      let(:questionnaire) { Quby::Compiler::DSL.build('questions_of_type_test', definition) }
    ...
    describe 'flags integration' do
      ...
      it 'presents flags that were defined in the definition' do
        expect(questionnaire.flags).to eq({ 'test_test' => Quby::Compiler::Entities::Flag.new(
                                                 key: :test_test,
                                                 description_true: 'Test flag',
                                                 description_false: 'Test flag uit',
                                                 shows_questions: [:v_1],
                                                 hides_questions: []),
                                            'test_test2' => Quby::Compiler::Entities::Flag.new(
                                                key: :test_test2,
