...
module Quby::Compiler::DSL
  describe ChartBuilder do
    ...
    let(:plottable) { Quby::Compiler::Entities::ScoreCalculation.new plottable_key, {} }
    ...
    let(:chart_class) { Quby::Compiler::Entities::Charting::Chart }
    ...
    describe '#plot' do
      ...
      it 'creates a plottable with the options merged into the plottable options' do
        ...
        expect(Quby::Compiler::Entities::Charting::Plottable).to receive(:new)
          .with(plottable.key,
      ...
      it 'sets the label from a question title when no label is present' do
        plottable = Quby::Compiler::Entities::Question.new plottable_key, title: 'some_title'
