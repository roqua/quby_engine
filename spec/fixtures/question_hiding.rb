...
panel do
  question :v_6, :type => :radio do
    ...
    option :a7, :value => 7, :description => "extreem unhide 3", :unhides_questions => [:v_8]
  end
  question :v_7, :type => :radio do
    ...
    option :a2, :value => 2, :description => "minimaal"
    option :a3, :value => 3, :description => "licht"
    option :a4, :value => 4, :description => "matig unhide 3", :unhides_questions => [:v_8]
    option :a5, :value => 5, :description => "matig ernstig unhide 3", :unhides_questions => [:v_8]
    option :a6, :value => 6, :description => "ernstig hide 3", :hides_questions => [:v_8]
    option :a7, :value => 7, :description => "extreem unhide 3", :unhides_questions => [:v_8]
  end
