...
panel do
question :v_14, :type => :radio, :presentation => :horizontal, :required => true do
...
question :v_15, :type => :radio, :presentation => :horizontal, :required => true do
...
question :v_16, :type => :scale, :presentation => :horizontal, :required => true do
...
panel do
question :v_17, :type => :scale, :presentation => :horizontal, :required => true do
...
question :v_18, :type => :scale, :presentation => :horizontal, :required => true do
...
panel do
question :v_19, :type => :scale, :presentation => :horizontal, :required => true do
...
question :v_20, :type => :scale, :presentation => :horizontal, :required => true do
