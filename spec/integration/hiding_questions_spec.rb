...
#end
#
#feature 'Unhiding questions' do
#  let(:questionnaire) { Quby::Questionnaire.find_by_key("question_hiding") }
#
#  scenario 'by clicking an option that unhides a question', :js => true do
#    visit_new_answer_for(questionnaire)
#    choose "answer_v_6_a6"
#    choose "answer_v_7_a5"
#    find("#answer_v_8_input").should be_visible
#  end
#  scenario 'by visiting an answer that has an option that unhides something filled in', :js => true do
