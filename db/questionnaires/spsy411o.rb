...
question :v_103, :type => :radio, :required => true do
  ...
  description ""
  option :a1, :value => 0, :description => "Vader"
  option :a2, :value => 1, :description => "Moeder"
  option :a3, :value => 2, :description => "Anders" do
...
panel do
  ...
  question :v_1, :type => :radio do
    ...
    description ""
    option :a1, :value => 0, :description => "Nederland"
    option :a2, :value => 1, :description => "Turkije"
    option :a3, :value => 2, :description => "Marokko"
    option :a4, :value => 3, :description => "Suriname"
    option :a5, :value => 4, :description => "Nederlandse Antillen"
    option :a6, :value => 5, :description => "Anders" do
  ...
  question :v_7, :type => :radio do
    ...
    description ""
    option :a1, :value => 0, :description => "Ja"
    option :a2, :value => 1, :description => "Nee"
  end
  ...
  question :v_3, :type => :radio do
    ...
    option :a2, :value => 1, :description => "Basisonderwijs"
    option :a3, :value => 2, :description => "(SBO) Speciale School voor Basisonderwijs"
    option :a4, :value => 3, :description => "(SO) Speciaal Onderwijs"
    option :a5, :value => 4, :description => "Praktijkschool"
    option :a6, :value => 5, :description => "(VSO) Voortgezet Speciaal Onderwijs"
    option :a7, :value => 6, :description => "(VMBO) Voorbereidend Middelbaar Beroeps Onderwijs"
    option :a8, :value => 7, :description => "(HAVO) Hoger Algemeen Voortgezet Onderwijs"
    option :a9, :value => 8, :description => "(VWO) Voorbereidend Wetenschappelijk Onderwijs"
    option :a10, :value => 9, :description => "(MBO, KMBO)Middelbaar Beroepsonderwijs"
    option :a11, :value => 10, :description => "(HBO) Hoger Beroepsonderwijs"
    option :a12, :value => 11, :description => "(WO) Wetenschappelijk Onderwijs"
    option :a13, :value => 12, :description => "Anders" do
      question :v_6, :type => :string, :title => "Namelijk"
    end
    option :a14, :value => 13, :description => "Typen basisonderwijs:"
    option :a15, :value => 14, :description => "Typen voortgezet onderwijs:"
  end
