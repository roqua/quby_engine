...
question :v_1, :type => :radio do
  ...
  option :a5, :value => 4, :description => "4 Storend tijdens bijna alle activiteiten, of ten minsten 'e'en ernstige fysieke aanval op anderen of dieren, of ernstige vernieling van eigendommen."
...
question :v_3, :type => :radio do
  ...
  option :a2, :value => 1, :description => "1 Af en toe gedachten over dood, of over zelfbeschadiging die niet leiden tot verwonding. Geen zelfbeschadiging of su'icidale gedachten."
  option :a3, :value => 2, :description => "2 Ongevaarlijke zelfbeschadiging, zoals krassen in polsen, al dan niet gepaard met su'icidale gedachten."
  option :a4, :value => 3, :description => "3 Matig ernstige intentie tot su'icide (inclusief voorbereidende handelingen, bijv. pillen verzamelen) of matige ongevaarlijke zelfbeschadiging (bijv. kleine overdosis)."
  option :a5, :value => 4, :description => "4 Ernstige su'icidepoging (bijv. ernstige overdosis), of ernstige opzettelijke zelfverwonding."
  option :a9, :value => 9, :description => "9Geen of onvoldoende informatie voorhanden."
end
...
question :v_7, :type => :radio do
  ...
  option :a3, :value => 2, :description => "2 Abnormale gedachten of waarnemingen doen zich voor (bijv. parano'ide idee'en, illusies of verstoring van het lichaamsbeeld) maar er is weinig lijdensdruk of uiting in bizar gedrag, d.w.z. klinisch aanwezig maar in lichte mate."
  ...
  option :a5, :value => 4, :description => "4 Geestestoestand en gedrag worden ernstig en nadelig be'invloed door wanen of hallucinaties of abnormale percepties, met ernstige impact op kind / adolescent of anderen."
  option :a9, :value => 9, :description => "9Geen of onvoldoende informatie voorhanden."
end
...
question :v_52, :type => :radio do
  ...
  description ""
  option :a1, :value => 0, :description => "0 Geen problemen tijdens de beoordeelde periode. Ouders / verzorgers zijn voldoende ge'informeerd over de problemen van het kind."
