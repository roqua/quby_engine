...
question :q1455992, :type => :radio do
...
question :q1455998, :type => :radio do
...
question :q1455999, :type => :radio do
...
question :q1456000, :type => :radio do
...
question :q1456001, :type => :radio do
...
question :q1456002, :type => :radio do
...
question :q1456003, :type => :radio do
...
question :q1456004, :type => :radio do
...
question :q1456005, :type => :radio do
...
question :q1456006, :type => :radio do
...
question :q1456008, :type => :radio do
...
question :q1456010, :type => :radio do
...
question :q1456011, :type => :radio do
...
question :q1456012, :type => :radio do
...
question :q1456013, :type => :radio do
  title "17. Ik praat aan één stuk door."
  description ""
  option :a1, :value => 1, :description => "Nooit of zelden"
  option :a2, :value => 2, :description => "Soms"
  option :a3, :value => 3, :description => "Vaak"
...
question :q1456014, :type => :radio do
...
question :q1456015, :type => :radio do
...
question :q1456016, :type => :radio do
...
question :q1456017, :type => :radio do
...
question :q1456018, :type => :radio do
...
question :q1456027, :type => :radio do
