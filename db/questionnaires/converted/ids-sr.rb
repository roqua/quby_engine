...
# Project ID 167579
# Date (GMT) 15-01-2010 09:32:20

key "ids-sr"
title "Zelfinvullijst Depressieve Symptomen (IDS-SR)"
description ""

question :q1398702, :type => :radio do
  ...
  option :a4, :value => 4, :description => "Het duurt meer dan 60 minuten om in slaap te vallen, meer dan de helft van de week"
end

question :q1398705, :type => :radio do
...
question :q1398707, :type => :radio do
...
question :q1398709, :type => :radio do
  ...
  option :a2, :value => 2, :description => "Ik slaap niet langer dan 10 uur binnen één etmaal (inclusief dutten)"
  option :a3, :value => 3, :description => "Ik slaap niet langer dan 12 uur binnen één etmaal (inclusief dutten)"
  option :a4, :value => 4, :description => "Ik slaap langer dan 12 uur binnen één etmaal (inclusief dutten)"
end

question :q1398711, :type => :radio do
...
question :q1398713, :type => :radio do
...
question :q1398716, :type => :radio do
...
question :q1398718, :type => :radio do
...
question :q1398840, :type => :radio do
  ...
  option :a2, :value => 2, :description => "Mijn stemming houdt vaak verband met de tijd van de dag tengevolge van omgevingsfactoren (bv alléén zijn, werken)"
...
question :q1435980, :type => :radio do
...
question :q1435984, :type => :radio do
...
question :q1398903, :type => :radio do
  ...
  option :a3, :value => 3, :description => "Mijn stemming is somber, maar deze somberheid is enigszins anders dan wat ik bij verdriet zou voelen"
  option :a4, :value => 4, :description => "Mijn stemming is somber, maar deze somberheid voelt geheel anders dan verdriet"
end

question :q1398934, :type => :radio do
...
question :q1435986, :type => :radio do
...
question :q1398938, :type => :radio do
  ...
  option :a4, :value => 4, :description => "Ik ben 2½ kg of meer afgevallen"
end

question :q1435991, :type => :radio do
  ...
  option :a4, :value => 4, :description => "Ik ben 2½ kg of meer aangekomen"
end

question :q1398942, :type => :radio do
  ...
  option :a4, :value => 4, :description => "Ik kan mij niet goed genoeg concentreren om te lezen of kan zelfs niet de kleinste beslissingen nemen"
end

question :q1398944, :type => :radio do
  title "16. Zelfbeeld:"
  description ""
  option :a1, :value => 1, :description => "Ik vind mijzelf even waardevol en nuttig als een ander"
  option :a2, :value => 2, :description => "maak mijzelf meer verwijten dan gewoonlijk"
...
question :q1398946, :type => :radio do
...
question :q1398949, :type => :radio do
...
question :q1398951, :type => :radio do
  ...
  option :a3, :value => 3, :description => "Ik heb alleen nog interesse in één of twee dingen die ik voorheen deed"
  option :a4, :value => 4, :description => "Ik heb vrijwel geen interesse meer in dingen die ik voorheen deed"
end

question :q1398953, :type => :radio do
  title "20. Energie:"
  description ""
  ...
  option :a3, :value => 3, :description => "Ik heb grote moeite met het beginnen aan of volhouden van gebruikelijke dagelijkse activiteiten (bijvoorbeeld boodschappen doen, huiswerk, koken, of naar het werk gaan)"
...
question :q1398955, :type => :radio do
...
question :q1398957, :type => :radio do
...
question :q1398959, :type => :radio do
...
question :q1398961, :type => :radio do
...
question :q1398963, :type => :radio do
  ...
  option :a2, :value => 2, :description => "Soms heb ik hoofd-, buik-, rug- of gewrichtspijn, maar deze pijnen zijn af en toe aanwezig en belemmeren mij niet dingen te doen"
...
question :q1398965, :type => :radio do
...
question :q1398967, :type => :radio do
...
question :q1398969, :type => :radio do
  ...
  option :a3, :value => 3, :description => "Ik heb vaak last van verstopping of diarree zonder dat dit mijn dagelijks functioneren beïnvloedt"
  option :a4, :value => 4, :description => "Ik heb last van verstopping of diarree waarvoor ik medicatie neem of waardoor mijn dagelijkse activiteiten worden beïnvloed"
end

question :q1398971, :type => :radio do
...
question :q1398973, :type => :radio do
