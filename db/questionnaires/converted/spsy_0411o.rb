...
# Project ID 426
# Date (GMT) 06-12-2010 20:57:49
# All values between 1 and 8 auto-recoded with -1
# Manual recodes: 1,3,8,103:+1;7:+1 en dan 2;
...
question :v_25, :type => :radio do
  title "14. Heeft minstens 'e'en goede vriend of vriendin."
  description ""
  option :a1, :value => 0, :description => "Zeker waar"
  option :a2, :value => 1, :description => "Beetje waar"
  option :a3, :value => 2, :description => "Niet waar"
...
question :v_88, :type => :radio do
  title "42. Denkt u over het geheel genomen dat uw kind moeilijkheden heeft op 'e'en van de volgende gebieden: emoties, concentratie, gedrag of vermogen om met andere mensen op te schieten?"
  description ""
