...
panel do
 title "Klachtenlijst (SCL-90)"
 text "In deze vragenlijst wordt u gevraagd in welke mate u last heeft van verschillende lichamelijke en psychische klachten. Wilt u voor elk van de onderstaande klachten aangeven in hoeverre u daarvan last heeft, door het antwoord aan te klikken dat het meest van toepassing is?

Het gaat er hierbij steeds om, hoe u zich *gedurende de afgelopen week, met vandaag erbij*, voelde.

Voorbeeld: 
In welke mate werd u gehinderd 
door:
...
Deze vragenlijst bevat 90 vragen.

Klik op 'Volgende vraag' om verder te gaan.

De test SCL'90 is door UMCG te Groningen vervaardigd na schriftelijke toestemming 01 juli 2009 van de uitgever Pearson te Amsterdam. Dit materiaal is auteursrechtelijk beschermd en kopiëren zonder schriftelijke toestemming van de uitgever is dan ook niet toegestaan."
end

panel do
text "*In welke mate werd u gehinderd door:*"
question :v_1, :type => :radio do
  title "1. Hoofdpijn"
  description ""
  option :a1, :value => 1, :description => "helemaal niet"
  option :a2, :value => 2, :description => "een beetje"
  option :a3, :value => 3, :description => "nogal"
  option :a4, :value => 4, :description => "tamelijk veel"
