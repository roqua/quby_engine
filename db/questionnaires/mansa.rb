...
panel do
  question :v_1, :type => :scale, :required => true do
  ...
  question :v_6, :type => :scale, :required => true do
  ...
  question :v_7, :type => :scale, :required => true do
  ...
  question :v_8, :type => :scale, :required => true do
...
panel do
  question :v_9, :type => :scale, :required => true do
  ...
  question :v_10, :type => :scale, :required => true do
...
panel do
  ...
  question :v_12, :type => :scale, :required => true do
...
panel do
  ...
  question :v_16, :type => :scale, :required => true do
  ...
  question :v_17, :type => :scale, :required => true do
  ...
  question :v_18, :type => :scale, :required => true do
  ...
  question :v_19, :type => :scale, :required => true do
  ...
  question :v_20, :type => :scale, :required => true do
