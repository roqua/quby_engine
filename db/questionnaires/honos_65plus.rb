...
# Project ID 390
# Date (GMT) 06-12-2010 20:45:02
# All values between 1 and 10 auto-recoded with -1
# Manual recodes: 85+1; '10':''
...
question :v_23, :type => :radio do
  ...
  option :a4, :value => 3, :description => "Gotere schade aan eigendommen (ernstiger)"
...
question :v_26, :type => :radio do
  ...
  description ""
  option :a1, :value => 0, :description => "Geen"
  option :a2, :value => 1, :description => "Meestal kalm en meewerkend"
  option :a3, :value => 2, :description => "Werkt soms tegen, behoefte aan overreding & aanmoediging"
  option :a4, :value => 3, :description => "Werkt vaak en duidelijk aanwezig tegen"
  option :a5, :value => 4, :description => "Ernstige tegenwerking of weerstand"
  option :a10, :value => 9, :description => ""
end
...
question :v_28, :type => :radio do
  ...
  description ""
  option :a1, :value => 0, :description => "1"
  option :a2, :value => 1, :description => "2"
  option :a3, :value => 2, :description => "3"
  option :a4, :value => 3, :description => "4"
  option :a5, :value => 4, :description => "Opzettelijk (bijv. urineren en/of defecatie)"
  option :a10, :value => 9, :description => ""
end
...
question :v_29, :type => :radio do
  ...
  option :a3, :value => 2, :description => "Met tussenpozen"
  option :a4, :value => 3, :description => "Aanhoudend"
  option :a5, :value => 4, :description => "Ernstig en onverdraaglijk voor anderen"
  option :a10, :value => 9, :description => ""
end
...
question :v_30, :type => :radio do
  ...
  option :a3, :value => 2, :description => "3"
  option :a4, :value => 3, :description => "4"
  option :a5, :value => 4, :description => "5"
  option :a10, :value => 9, :description => ""
end
...
question :v_32, :type => :radio do
  ...
  description ""
  option :a1, :value => 0, :description => "Geen"
  option :a2, :value => 1, :description => "Liever dood zijn - dood willen zijn maar geen gedachten over zelfbeschadiging"
...
question :v_33, :type => :radio do
  ...
  option :a1, :value => 0, :description => "Geen"
  option :a2, :value => 1, :description => "Geen"
  option :a3, :value => 2, :description => "Licht (bijv. geen maatregelen nemen bij potentieel levens- bedreigende situaties)"
...
question :v_34, :type => :radio do
  ...
  option :a4, :value => 3, :description => "Geen"
...
question :v_47, :type => :radio do
  ...
  option :a1, :value => 0, :description => "Geen"
  option :a2, :value => 1, :description => "Geen"
  option :a3, :value => 2, :description => "Regelmatig"
  option :a4, :value => 3, :description => "Duidelijk aanwezig"
...
question :v_54, :type => :radio do
  ...
  option :a4, :value => 3, :description => "Kan geen nieuwe informatie onthouden (onthoudt alleen materiaal dat steeds wordt herhaald)"
...
question :v_55, :type => :radio do
  ...
  option :a4, :value => 3, :description => "Meestal gedesori'enteerd in tijd en vaak in plaats"
  option :a5, :value => 4, :description => "Voortdurend gedesori'enteerd in tijd en plaats en soms in persoon"
  option :a10, :value => 9, :description => ""
end
...
question :v_56, :type => :radio do
  ...
  description ""
  option :a1, :value => 0, :description => "Geen"
  option :a2, :value => 1, :description => "Geen problemen met taalgebruik"
...
question :v_66, :type => :radio do
  ...
  option :a2, :value => 1, :description => "Geen"
  option :a3, :value => 2, :description => "Licht"
  option :a4, :value => 3, :description => "Matig bijv. levercirrose"
  option :a5, :value => 4, :description => "ErnstigBeperkt bewustzijns- niveau, bijv. lethargisch"
  option :a10, :value => 9, :description => ""
end
...
question :v_69, :type => :radio do
  ...
  option :a1, :value => 0, :description => "Geen"
  option :a2, :value => 1, :description => "Geen"
  option :a3, :value => 2, :description => "Aanwezig maar weinig lijdensdruk"
...
question :v_76, :type => :radio do
  ...
  option :a3, :value => 2, :description => "Duidelijke depressie op subjectieve en objectieve maatstaven (bijv. verlies van belangstelling, plezier of zelfwaardering, gebrek aan energie, of schuldgevoelens)"
...
question :v_85, :type => :radio do
  ...
  description ""
  option :a1, :value => 1, :description => "A) Fobie'en"
...
question :v_82, :type => :radio do
  ...
  option :a3, :value => 2, :description => "Bewijs voor duidelijke problemen met het maken / onderhouden van / aanpassen aan ondersteunende relaties (bijv. vanwege dwingend optreden of voortkomend uit moeizame / uitbuitende / mishandelende relatie met verzorgers)Problemen gemeld door pati'ent of duidelijk voor anderen"
...
question :v_84, :type => :radio do
  ...
  option :a4, :value => 3, :description => "Lijdensdruk (duidelijk aanwezig) (de pati'ent en/of anderen)"
...
question :v_87, :type => :radio do
  ...
  option :a5, :value => 4, :description => "Ernstig onvermogen op bijna alle gebieden van persoonlijke en huishoudelijke ADL (bijv. volledig toezicht nodig bij aankleden en eten, regelmatig incontinentie van urine en faeces.)"
  option :a10, :value => 9, :description => ""
end
...
question :v_90, :type => :radio do
  ...
  option :a3, :value => 2, :description => "Enige duidelijk aanwezige problemen met huisvesting of hulpmiddelen en aanpassingen.Basis- voorzieningen aanwezig."
  option :a4, :value => 3, :description => "Slecht - Afwezigheid van 1 of meer basis- voorzieningen (bijv. slechte kookfaciliteiten)"
  option :a5, :value => 4, :description => "Ernstige problemen. Heel slecht. (bijv. dakloos, ontoelaatbare woon- omstandigheden)"
  option :a10, :value => 9, :description => ""
end
...
question :v_91, :type => :radio do
  ...
  option :a2, :value => 1, :description => "Activiteiten beschikbaar maar niet op geschikte tijden, enz."
...
question :v_92, :type => :radio do
  ...
  option :a4, :value => 3, :description => "Pati'ent wil of kan vaak geen gebruik maken van faciliteiten"
