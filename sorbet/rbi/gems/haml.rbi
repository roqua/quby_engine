...
class Haml::Parser::Line < Anonymous_Struct_17
  def eod?; end
  def strip!(from); end
  def tabs; end
end
...
class Haml::Parser::ParseNode < Anonymous_Struct_18
...
class Haml::Parser::DynamicAttributes < Anonymous_Struct_19
  def old=(value); end
...
class Haml::AttributeCompiler::AttributeValue < Anonymous_Struct_20
  def to_literal; end
end
