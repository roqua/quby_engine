...
class Appraisal::BundlerDSL
  ...
  def git_sources_entry; end
  def git_sources_entry_for_dup; end
  ...
  def path_sources_entry; end
  def path_sources_entry_for_dup; end
...
class Appraisal::Appraisal
  def bundle_parallel_option(job_size); end
  ...
  def install(job_size = nil); end
  def install_command(job_size); end
