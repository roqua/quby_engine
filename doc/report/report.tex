...
\ifpdf  
    \pdfinfo { /Title  (Building a domain-specific language for domain-specific languages)
               /Creator (TeX)
               /Producer (pdfTeX)
               /Author (Marten Veldthuis marten@veldthuis.com)
               /CreationDate (D:YYYYMMDDhhmmss)  %format D:YYYYMMDDhhmmss
               /ModDate (D:YYYYMMDDhhmm)
               /Subject (dsl)
               /Keywords (ruby, rails, dsl, questionnaires, webapps) }
    \pdfcatalog { /PageMode (/UseOutlines)
                  /OpenAction (fitbh)  }
\fi


\title{Building a domain-specific language for domain-specific languages}
...
\ifpdf
  \author{\href{mailto:marten@veldthuis.com}{Marten Veldthuis}}
%  \cityofbirth{born in XYZ} % uncomment this if your university requires this
%  % If city of birth is required, also uncomment 2 sections in PhDthesisPSnPDF
%  % Just search for the "city" and you'll find them.
  \collegeordept{\href{http://www.cs.rug.nl}{Computing Science}}
  \university{\href{http://www.rug.nl}{Rijksuniversiteit Groningen}}
