...
question :q592164, :type => :radio do
  ...
  option :a4, :value => 4, :description => "3Duidelijke zucht naar of afhankelijkheid van alcohol of drugs met frequent controleverlies; risico´s nemen onder invloed."
