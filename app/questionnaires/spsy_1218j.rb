...
question :q860435, :type => :radio do
  title "11. Ik heb minstens één goede vriend of vriendin."
  description ""
  option :a1, :value => 1, :description => "Zeker waar"
  option :a2, :value => 2, :description => "Beetje waar"
  option :a3, :value => 3, :description => "Niet waar"
...
question :q860481, :type => :radio do
  title "29. Ik doe erg mijn best om af te vallen (bijv. strenge diëten volgen of bijna niet eten)."
  description ""
  option :a1, :value => 1, :description => "Niet waar"
  option :a2, :value => 2, :description => "Beetje waar"
  option :a3, :value => 3, :description => "Zeker waar"
...
question :q860584, :type => :radio do
  title "41. Gebruik je wel eens drugs? (drugs zijn hasj, weed, marihuana, XTC, heroïne, cocaïne, paddo´s, slaappillen enz.; pillen tellen niet als drugs als je ze verkregen hebt van de dokter)."
  description ""
  option :a1, :value => 1, :description => "Niet waar"
  option :a2, :value => 2, :description => "Beetje waar"
  option :a3, :value => 3, :description => "Zeker waar"
...
question :q860609, :type => :radio do
  title "47. Denk je over het geheel genomen dat je moeilijkheden hebt op één of meer van de volgende gebieden: emoties, concentratie, gedrag of vermogen om met andere mensen op te schieten?"
  description ""
