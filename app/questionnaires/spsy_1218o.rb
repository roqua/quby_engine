...
# Project ID 84298
# Date (GMT) 15-01-2010 08:59:37

key "spsy_1218o"
title "SPsy 12-18 Ouders"
description ""

question :q1866316, :type => :radio do
...
question :q860437, :type => :radio do
  title "12. Vecht vaak. Het lukt de leerling andere mensen te laten doen wat hij/zij wil."
  description ""
  option :a1, :value => 1, :description => "Niet waar"
  option :a2, :value => 2, :description => "Beetje waar"
  option :a3, :value => 3, :description => "Zeker waar"
...
question :q860560, :type => :radio do
...
question :q860565, :type => :radio do
  ...
  option :a3, :value => 3, :description => "2-4 keer per maand"
  option :a4, :value => 4, :description => "2-3 keer per week"
...
question :q860584, :type => :radio do
  title "41. Gebruikt drugs. (Drugs zijn hasj, weed, marihuana, XTC, heroïne, cocaïne, paddo´s, slaappillen enz.; pillen tellen niet als drugs als je ze verkregen hebt van de dokter)"
  description ""
  option :a1, :value => 1, :description => "Niet waar"
  option :a2, :value => 2, :description => "Beetje waar"
  option :a3, :value => 3, :description => "Zeker waar"
...
question :q860609, :type => :radio do
  title "47. Denkt u over het geheel genomen dat uw kind moeilijkheden heeft op één van de volgende gebieden: emoties, concentratie, gedrag of vermogen om met andere mensen op te schieten?"
  description ""
...
question :q860613, :type => :radio do
  ...
  option :a2, :value => 2, :description => "1 - 5 maanden"
  option :a3, :value => 3, :description => "6 - 12 maanden"
